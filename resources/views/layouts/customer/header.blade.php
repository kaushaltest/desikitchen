...
<link href="{{ asset('customer-assets/lib/animate/animate.min.css') }}" rel="stylesheet">
<link href="{{ asset('customer-assets/lib/owlcarousel/assets/owl.carousel.min.css') }}" rel="stylesheet">
<link href="{{ asset('customer-assets/lib/tempusdominus/css/tempusdominus-bootstrap-4.min.css') }}" rel="stylesheet" />
